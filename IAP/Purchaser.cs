...
namespace CompleteProject
{
	...
	public class Purchaser : MonoBehaviour, IStoreListener
	{
		...
		private static string Coins100  =    "com.turtlesquad.coins100";                                                         // General handle for the consumable product.
		private static string Coins500  =    "com.turtlesquad.coins500";                                                         
		private static string Coins1000 =    "com.turtlesquad.coins1000";                                                         
		private static string NoAdsNonConsumable = "com.turtlesquad.noads";                                                  // General handle for the non-consumable product.
...
//		private static string kProductNameGooglePlaySubscription =  "com.unity3d.test.services.purchasing.subscription";  // Google Play Store identifier for the subscription product.
		...
		public void BuyNonConsumable()
		{
			...
			BuyProductID(NoAdsNonConsumable);
		}
