...
public class LevelOverAnimation : MonoBehaviour {
...
//	public GameObject turtle;
	...
	//	public GameObject greenShell;			//for itween 
	//	public GameObject greenShadow;			//for itween
//	public GameObject enterGates;
	...
	//	turtle.transform.position = greenBall.transform.position;
	//	Vector3 player = turtle.transform.localScale;
	//	player.x *= -1;
	//	turtle.transform.localScale = player;
//		Debug.Log("green: " + green.transform.position);
//		Debug.Log("turtle: " + turtle.transform.position);
	...
	//		anim.SetTrigger("Idle");
			...
			if(greenBall.transform.position.y  < -9.0f){
		//	Debug.Log("pos: "+ green.transform.position.y);
				yPos = -10.5f;
			}else{yPos = greenBall.transform.position.y;}
	...
	IEnumerator MoveTo(){
		for(float t = 0; t < 1; t+=Time.unscaledDeltaTime/0.5f){
			...
			MainCamera.transform.position = Vector3.Lerp(MainCamera.transform.position, new Vector3(greenBall.transform.position.x, yPos + 1.5f, greenBall.transform.position.z - 10), Speed * Time.unscaledDeltaTime);
