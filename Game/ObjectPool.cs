...
public class ObjectPool : MonoBehaviour
{
	...
	public GameObject containerObject;					//A parent object for pooled objects to be nested under. Keeps the hierarchy clean
	...
	{
	//	Debug.Log("objectType: " + objectType.name);
		...
		for(int i=0; i<prefabs.Length; i++)
		{
			...
			{
			//	Debug.Log("objectType2: " + objectType.name);
